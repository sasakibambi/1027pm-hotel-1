...
<head>
    ...
    <title>管理者ページ-お問い合わせ削除- | Bord de mer HOTEL</title>
...
<body>
    ...
    <article class="admin">
        <div class="w-container">
            <h1 class="heading-decoration">管理者ページ <span>-お問い合わせ削除-</span></h1>
            <div class="entry-container contact">
                <form action="delete_done.php" method="post">
                    <ul>
                        <li>内容を確認し、削除する場合は「削除する」をクリックしてください。</li>
                    </ul>
                    ...
                    <div class="form-content">
                        ...
                        <?= htmlspecialchars($result['mail'],ENT_QUOTES) ?>
                    </div>
                    <div class="form-content">
                        <div class="form-label">お問い合わせの種類</div>
                        <?= $kind_array[$result['kind']] ?>
                    </div>
                    <div class="form-content">
                        <div class="form-label">お問い合わせ内容</div>
                        <?= nl2br(htmlspecialchars($result['comment'],ENT_QUOTES)) ?>
                    </div>
                    <div class="button-wrapper">
                        <input type="hidden" name="id" value="<?= $result['id'] ?>">
                        <input type="submit" class="btn btn-accent" value="削除する">
